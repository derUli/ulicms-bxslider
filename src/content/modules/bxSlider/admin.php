...
function bxSlider_admin() {
    ...
    <div class="row">
        ...
        <div class="col-xs-6 text-right">
            <p>
                <a href="index.php?action=bxslider_new"
                   class="btn btn-primary">
                       <?php echo icon("fa fa-plus"); ?>
                    <?php translate("bxslider_new"); ?></a>
            </p>
        </div>
    </div>
    ...
    <table class="tablesorter">
        ...
        <th class="no-sort"><?php translate("code_to_embed"); ?></th>
            ...
            <tr>
                ...
                <td>
                    <a
                        ...
                        >
                            <?php echo icon("fa fa-eye"); ?>
                        <?php Template::escape($dataset->title); ?></a>
                </td>
