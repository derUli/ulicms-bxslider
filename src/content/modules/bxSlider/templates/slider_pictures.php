    ...
    if (!$slider) {
        ...
        <div class="row">
            <div class="col-xs-6">
                <p>
                    <a
                        href="<?php Template::escape(ModuleHelper::buildAdminURL("bxSlider")); ?>"
                        class="btn btn-default btn-back">
                            <?php echo icon("fa fa-arrow-left"); ?>
                        <?php translate("back_to_list"); ?></a></a>
            ...
            <div class="col-xs-6 text-right">
                <p>
                    <a
                        href="<?php Template::escape(ModuleHelper::buildActionURL("bxslider_picture_new", "slider_id=$id")); ?>"
                        class="btn btn-default"
                        >
                        <?php echo icon("fa fa-plus"); ?>                                               <?php translate("add_image"); ?></a>
                </p>
            </div>
        ...
        <table class="tablesorter">
            <thead>
                <tr>
                    ...
                    <th class="no-sort" ><?php translate("image"); ?></th>
                    <td class="no-sort"></td>
                    <td class="no-sort"></td>
                </tr>
            </thead>
